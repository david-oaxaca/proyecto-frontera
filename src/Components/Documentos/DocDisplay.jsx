...
const DocDisplay = (props) => {
  ...
  return (
    <div className="doc-container">
      ...
      {pdfsUrls &&
        pdfsUrls.slice(0, pdfsUrls.length).map((docZone) => (
      ...
      {!pdfsUrls.length === 0 && (
        <div className="pdf-display">No pdf file selected</div>
      )}
      ...
      <div className="doc-option" onClick={() => props.handleType("")}>
        ...
        <div className="option-text-container">Volver a las opciones</div>
      </div>
    </div>
  );
};
