  ...
  return (
    <>
          ...
          <div className="container-fluid ">
            ...
            >
              ...
              <ul className="navbar-nav">
                ...
                <li className="nav-item">
                  <NavLink className={"nav-link"} to="/SubirFoto">
                    Subir Foto
                  </NavLink>
                </li>
                <li className="nav-item">
                  <NavLink className={"nav-link"} to="/SubirDocumento">
                    Subir Documento
                  </NavLink>
                </li>
              </ul>
      ...
      <div
        ...
        style={{ transform: `translate3d(${sidebar * 55 - 55}%, 0, 0)` }}
      >
        <div className="drawer-content">
          <NavLink
            className={"nav-link drawer-option"}
            onClick={showSidebar}
            to="/"
          >
            Inicio
