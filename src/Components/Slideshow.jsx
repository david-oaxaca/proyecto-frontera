...
const slides = [
                ...
                {
                    "color": "#36AE7C", 
                    "image_url": "https://drive.google.com/uc?export=view&id=1tvabzpMwjruLwaW_n1l0ErBRI_11PZRy",
                ...
                {
                    "color": "#F9D923", 
                    "image_url": "https://drive.google.com/uc?export=view&id=1qtmTJeNkY8TPnjobQdxhB5NM3w7XNggx",
...
const Slideshow = () => {
    ...
    return (
        <div className='slideshow'>
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" className="bi bi-arrow-bar-left" viewBox="0 0 16 16">
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" className="bi bi-arrow-bar-right" viewBox="0 0 16 16">
